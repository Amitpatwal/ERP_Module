...
function printSo() {
    ...
    var idd = url.get('sono');
    $.ajax({
        'url': '/api/SO/PrintSO?sono=' + idd,
        'type': 'GET',
        ...
        success: function (data) {
            if (data.success == true) {
                ...
                document.getElementById('pino').innerHTML = data.data[0].soNo;
                var pidate = data.data[0].soDate;
                ...
                var soNo = data.data[0].soNo;
                var title = Billcompanyname + '_' + soNo;
              

                datatable = $("#ItemTable").DataTable({
                    ajax: {
                        'url': '/api/SO/PrintItemSO?sono=' + soNo,
                        'type': 'GET',
                        'contentType': 'application/json',
                    },
                    columns:
                        [
...

                            {
                                'data': 'itemid', 'render': function (data, type, row) {
                                    ...
                                    return html1;
                                }, 'width': '35%', 'min- height': '200px'    , 'font-size': '10px', 'font-size': '90%', 'font-family': 'Tahoma',
                            },
