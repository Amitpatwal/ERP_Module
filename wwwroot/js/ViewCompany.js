...
function LoadDatatable() {
    dataTable = $("#companylist").DataTable({
        ...
        columns: [
            ...
            { 'data': 'financialYear', 'defaultContent': '', 'width': '5%' },
            { 'data': 'email', 'defaultContent': '', 'width': '10%' },
            { 'data': 'phone', 'defaultContent': '', 'width': '5%' },
            { 'data': 'gst', 'defaultContent': '', 'width': '5%' },
            { 'data': 'pan', 'defaultContent': '', 'width': '5%' },
            { 'data': 'address', 'defaultContent': '', 'width': '20%' },

            {
                'data': 'companyid', 'render': function (data, type, row) {
                    return `<a class="btn btn-primary btn-sm" style="color:white" onclick=updateCompany(${row.Companyid})>  <i class="fas fa-pencil-alt">
                              </i>
                              Edit</a>

                                    <a class="btn btn-danger btn-sm" style="color:white" onclick=DeleteCompany(${row.companyid})>   <i class="fas fa-trash">
                              </i>
                              Delete </a>
